...
class _AdminVideoListPageState extends State<AdminVideoListPage> {
  ...
  final List<VideoTape> _videoTapes = [
    VideoTape(
      ...
      title: 'Jurassic Park',
      price: 29.99,
      description: 'Experience the thrill of dinosaurs in this classic masterpiece.',
      genreId: '1',
      genreName: 'Sci-Fi',
      level: 1,
      imageUrls: [
  ...
  Future<void> _loadData() async {
    ...
    try {
      // TODO: Implement API call to get video tapes
  ...
  Future<void> _deleteVideoTape(VideoTape tape) async {
    ...
    if (confirmed ?? false) {
      setState(() => _isLoading = true);
      try {
        // TODO: Implement API call to delete video tape
        await Future.delayed(const Duration(seconds: 1));
        setState(() {
